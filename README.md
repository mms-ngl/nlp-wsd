...
#### Project directory
[[Downloads]](https://drive.google.com/drive/folders/1SEdDLFvQoapy0_jED9_OpE3JJzXPYKB8?usp=sharing) Trained model and saved label vocabulary: label2id.pth, model_weights.pth.
```
root
- data
- logs
